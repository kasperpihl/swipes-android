...
public class DoneListAdapter extends ArrayAdapter {
    ...
    public DoneListAdapter(Context context, int layoutResourceId, List<GsonTask> data) {
    ...
    public int getCount() {
        ...
        if (mListContentsListener != null) {
            if (count != 0) {
                ...
                mListContentsListener.onEmpty(Sections.DONE);
            }
        }
        return count;
    }
