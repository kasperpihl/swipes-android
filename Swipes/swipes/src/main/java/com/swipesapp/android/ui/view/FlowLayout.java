...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs) {
        ...
        horizontalSpacing = styledAttributes.getDimensionPixelSize(
                R.styleable.FlowLayout_android_horizontalSpacing, DEFAULT_HORIZONTAL_SPACING);
        verticalSpacing = styledAttributes.getDimensionPixelSize(
                R.styleable.FlowLayout_android_verticalSpacing, DEFAULT_VERTICAL_SPACING);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (View child : getLayoutChildren()) {
            ...
            int childWidthSpec = createChildMeasureSpec(childLayoutParams.width,
                    maxInternalWidth, widthMode);
            int childHeightSpec = createChildMeasureSpec(childLayoutParams.height,
                    maxInternalHeight, heightMode);
